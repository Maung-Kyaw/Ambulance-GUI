...
private int followSpeed = 5; // Speed at which the patient moves
    ...
    "WWGGGGGGWWWWWWWGGGGGGGGGW",
    "WWWWWGGGGGGGGGGGGGGGGGGGW",
    "WWWWWWWWWWGGGGGGGGWWWWWWW",
    "WWWWWWGGGGGGGGGWWWWWWWWWW",
    "WWWWWWGGGGGGWWWWWWWWWWWWW",
    "WWWWWWWWWWGGGGGGGGGGGGWWW",
    "WWWWWWWGGGGGGGGGGWWWWWWWW",
    "WWWWWWWWWWWWWGGGGGGGGGWWW",
    "WWWWWWWWWWWWWWWWWWWWWWWWW",
    "WWWWWWWWWWWWWWWWWWWWWWWWW",
    "WWWWWWWWWWWWWWWWWWWWWWWWW"
};
    ...
    public GamePanel() {
        ...
        patientImage= new ImageIcon("src/main/java/project3_6581178/Assets/patient.png").getImage();
...
public void mousePressed(MouseEvent e) {
    ...
    boolean isVanNearDoor = Math.abs(vanX - doorX) <= tileSize && Math.abs(vanY - doorY) <= tileSize;
    boolean clickedOnDoor = mouseX >= doorX && mouseX < doorX + tileSize &&
                            mouseY >= doorY && mouseY < doorY + tileSize;

    if (isVanNearDoor && clickedOnDoor) {
        new FinalFrame();
    }
}
